 ...
 * @author Naveen
 */
public class DDBIndexQueryWithOrOper {
    public static void main(String args[]){
        ...
        QuerySpec spec = new QuerySpec()
            ...
            .withFilterExpression("city = :city_name_1 or city = :city_name_2")
            .withValueMap(new ValueMap()
                .withString(":country_name","United States")
                .withString(":city_name_1", "West Lafayette")
                .withString(":city_name_2", "Higbee"));
